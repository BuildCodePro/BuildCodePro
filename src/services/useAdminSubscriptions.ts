...
const getSubscriptionStatsApi =
    async (): Promise<AdminSubscriptionStatsResponse> => {
        return apiRequest<AdminSubscriptionStatsResponse>(
            API_ENDPOINTS.ADMIN_SUBSCRIPTIONS.STATS,
        );
    };
...
const getSubscriptionsApi = async (
    ...
    return apiRequest<AdminSubscriptionsResponse>(
        `${API_ENDPOINTS.ADMIN_SUBSCRIPTIONS.LIST}${buildQueryString(
...
const getInvoicesApi = async (
    ...
    return apiRequest<AdminInvoicesResponse>(
        `${API_ENDPOINTS.ADMIN_SUBSCRIPTIONS.INVOICES}${buildQueryString(
            params as Record<string, unknown> | undefined,
        )}`,
    );
};
...
export const useAdminSubscriptionStatsQuery = () => {
    return useQuery({
        queryKey: QUERY_KEYS.ADMIN_SUBSCRIPTIONS.STATS,
...
export const useAdminSubscriptionsQuery = (
    ...
    return useQuery({
        queryKey: QUERY_KEYS.ADMIN_SUBSCRIPTIONS.LIST(
            params as Record<string, unknown> | undefined,
        ),
...
export const useAdminInvoicesQuery = (params?: AdminInvoicesParams) => {
    return useQuery({
        queryKey: QUERY_KEYS.ADMIN_SUBSCRIPTIONS.INVOICES(params),
        queryFn: () => getInvoicesApi(params),
    });
};

export const useAdminInvoicePdfQuery = (
