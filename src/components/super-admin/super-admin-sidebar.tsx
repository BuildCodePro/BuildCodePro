    ...
    >
      <div className="relative flex h-[72px] shrink-0 items-center justify-center px-4">
        <Link
          ...
          onClick={onNavigate}
          aria-label="BuildCode Pro super admin home"
        >
      ...
      <div className="px-4 pt-4">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 font-body text-xs font-medium text-sky-400">
